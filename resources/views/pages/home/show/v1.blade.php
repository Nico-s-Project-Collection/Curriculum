        ...
        <x-section.v1>
            ...
            <x-slot name="content">
                <ul class="flex flex-col gap-y-8 px-4 lg:px-8">
                    ...
                    <x-job.item.v1 :position="'Analista de Dados'"             :enterprise="'Grupo DDM'" :period="'Jul de 2025 - --- de ----'"></x-job.item.v1>
                </ul>
            </x-slot>
        </x-section.v1>
        <x-section.v1>
                ...
                <x-competence.container.v1>
                    ...
                    <x-slot name="content">
                        <x-h-scroll.container.v1>
                            <x-h-scroll.item.v1>
                                <x-slot name="icon">
                                    <svg class="h-12 lg:h-24 w-16 lg:w-32 min0w-16 lg:min-w-32" fill="#000000" width="800px" height="800px" viewBox="0 0 14 14" role="img" focusable="false" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
